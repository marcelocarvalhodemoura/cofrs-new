<button type="button" id="btnAddDownloadFile" class="btn btn-primary bs-popover rounded mb-2 mr-2" data-placement="top"  data-container="body" data-trigger="hover" data-content="Baixa de arquivo" data-target="#convenantModalDownloadFiles">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Baixa de Arquivo</h5>
