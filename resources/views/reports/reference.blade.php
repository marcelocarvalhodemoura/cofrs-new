        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 ">
            <nav class="breadcrumb-two" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="">Referências</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            <div class="widget-content-area br-4">
                <div class="widget-one">
                    ...
                    <p class="">Página do Sistema Cofrs destinada a emissão do relatório de referências.<br />Selecione os filtro e pressione buscar para pré-visualizar o relatório.</p>
                    <br />
                    <div class="row">
                        <div class="col-md-12 text-right">
                            @include('reports.form.form-reference')
                        </div>
                    </div>
                </div>
            </div>
